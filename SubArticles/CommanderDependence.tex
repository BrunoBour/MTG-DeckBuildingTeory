...
Esse é o caso em que você pode utilizar muito menos proteções interativas que jogam na pilha, e passar a utilizar apenas as cartas que protegem o general, mas ainda tenham alguma outra função, como por exemplo \card{Selfless Spirit}, \card{Swiftfoot Boots} ou \card{Lightning Greaves}.
...
Neste mundo faz muito mais sentido utilizar peças de interação que podem lhe ajudar em outros contextos como por exemplo counterspells ou efeitos como \card{Silence}, pois já que seu comandante terá um papel espontâneo, você só precisa garantir que ele resolverá e cumprirá seu papel uma única vez.
